...
export default [
  {
    ...
    "config": {
      "themeColors": {
        "c-primary": "rgb(103, 80, 164)",
        "c-primary-dark-100": "rgb(93,72,148)",
        "c-primary-dark-100-alpha-100": "rgba(93, 72, 148, 0.90)",
        "c-primary-alpha-100": "rgba(103, 80, 164, 0.90)",
        "c-primary-dark-100-alpha-200": "rgba(93, 72, 148, 0.80)",
        "c-primary-alpha-200": "rgba(103, 80, 164, 0.80)",
        "c-primary-dark-100-alpha-300": "rgba(93, 72, 148, 0.70)",
        "c-primary-alpha-300": "rgba(103, 80, 164, 0.70)",
        "c-primary-dark-100-alpha-400": "rgba(93, 72, 148, 0.60)",
        "c-primary-alpha-400": "rgba(103, 80, 164, 0.60)",
        "c-primary-dark-100-alpha-500": "rgba(93, 72, 148, 0.50)",
        "c-primary-alpha-500": "rgba(103, 80, 164, 0.50)",
        "c-primary-dark-100-alpha-600": "rgba(93, 72, 148, 0.40)",
        "c-primary-alpha-600": "rgba(103, 80, 164, 0.40)",
        "c-primary-dark-100-alpha-700": "rgba(93, 72, 148, 0.30)",
        "c-primary-alpha-700": "rgba(103, 80, 164, 0.30)",
        "c-primary-dark-100-alpha-800": "rgba(93, 72, 148, 0.20)",
        "c-primary-alpha-800": "rgba(103, 80, 164, 0.20)",
        "c-primary-dark-100-alpha-900": "rgba(93, 72, 148, 0.10)",
        "c-primary-alpha-900": "rgba(103, 80, 164, 0.10)",
        "c-primary-dark-200": "rgb(84,65,133)",
        "c-primary-dark-200-alpha-100": "rgba(84, 65, 133, 0.90)",
        "c-primary-dark-200-alpha-200": "rgba(84, 65, 133, 0.80)",
        "c-primary-dark-200-alpha-300": "rgba(84, 65, 133, 0.70)",
        "c-primary-dark-200-alpha-400": "rgba(84, 65, 133, 0.60)",
        "c-primary-dark-200-alpha-500": "rgba(84, 65, 133, 0.50)",
        "c-primary-dark-200-alpha-600": "rgba(84, 65, 133, 0.40)",
        "c-primary-dark-200-alpha-700": "rgba(84, 65, 133, 0.30)",
        "c-primary-dark-200-alpha-800": "rgba(84, 65, 133, 0.20)",
        "c-primary-dark-200-alpha-900": "rgba(84, 65, 133, 0.10)",
        "c-primary-dark-300": "rgb(76,59,120)",
        "c-primary-dark-300-alpha-100": "rgba(76, 59, 120, 0.90)",
        "c-primary-dark-300-alpha-200": "rgba(76, 59, 120, 0.80)",
        "c-primary-dark-300-alpha-300": "rgba(76, 59, 120, 0.70)",
        "c-primary-dark-300-alpha-400": "rgba(76, 59, 120, 0.60)",
        "c-primary-dark-300-alpha-500": "rgba(76, 59, 120, 0.50)",
        "c-primary-dark-300-alpha-600": "rgba(76, 59, 120, 0.40)",
        "c-primary-dark-300-alpha-700": "rgba(76, 59, 120, 0.30)",
        "c-primary-dark-300-alpha-800": "rgba(76, 59, 120, 0.20)",
        "c-primary-dark-300-alpha-900": "rgba(76, 59, 120, 0.10)",
        "c-primary-dark-400": "rgb(68,53,108)",
        "c-primary-dark-400-alpha-100": "rgba(68, 53, 108, 0.90)",
        "c-primary-dark-400-alpha-200": "rgba(68, 53, 108, 0.80)",
        "c-primary-dark-400-alpha-300": "rgba(68, 53, 108, 0.70)",
        "c-primary-dark-400-alpha-400": "rgba(68, 53, 108, 0.60)",
        "c-primary-dark-400-alpha-500": "rgba(68, 53, 108, 0.50)",
        "c-primary-dark-400-alpha-600": "rgba(68, 53, 108, 0.40)",
        "c-primary-dark-400-alpha-700": "rgba(68, 53, 108, 0.30)",
        "c-primary-dark-400-alpha-800": "rgba(68, 53, 108, 0.20)",
        "c-primary-dark-400-alpha-900": "rgba(68, 53, 108, 0.10)",
        "c-primary-dark-500": "rgb(61,48,97)",
        "c-primary-dark-500-alpha-100": "rgba(61, 48, 97, 0.90)",
        "c-primary-dark-500-alpha-200": "rgba(61, 48, 97, 0.80)",
        "c-primary-dark-500-alpha-300": "rgba(61, 48, 97, 0.70)",
        "c-primary-dark-500-alpha-400": "rgba(61, 48, 97, 0.60)",
        "c-primary-dark-500-alpha-500": "rgba(61, 48, 97, 0.50)",
        "c-primary-dark-500-alpha-600": "rgba(61, 48, 97, 0.40)",
        "c-primary-dark-500-alpha-700": "rgba(61, 48, 97, 0.30)",
        "c-primary-dark-500-alpha-800": "rgba(61, 48, 97, 0.20)",
        "c-primary-dark-500-alpha-900": "rgba(61, 48, 97, 0.10)",
        "c-primary-dark-600": "rgb(55,43,87)",
        "c-primary-dark-600-alpha-100": "rgba(55, 43, 87, 0.90)",
        "c-primary-dark-600-alpha-200": "rgba(55, 43, 87, 0.80)",
        "c-primary-dark-600-alpha-300": "rgba(55, 43, 87, 0.70)",
        "c-primary-dark-600-alpha-400": "rgba(55, 43, 87, 0.60)",
        "c-primary-dark-600-alpha-500": "rgba(55, 43, 87, 0.50)",
        "c-primary-dark-600-alpha-600": "rgba(55, 43, 87, 0.40)",
        "c-primary-dark-600-alpha-700": "rgba(55, 43, 87, 0.30)",
        "c-primary-dark-600-alpha-800": "rgba(55, 43, 87, 0.20)",
        "c-primary-dark-600-alpha-900": "rgba(55, 43, 87, 0.10)",
        "c-primary-dark-700": "rgb(50,39,78)",
        "c-primary-dark-700-alpha-100": "rgba(50, 39, 78, 0.90)",
        "c-primary-dark-700-alpha-200": "rgba(50, 39, 78, 0.80)",
        "c-primary-dark-700-alpha-300": "rgba(50, 39, 78, 0.70)",
        "c-primary-dark-700-alpha-400": "rgba(50, 39, 78, 0.60)",
        "c-primary-dark-700-alpha-500": "rgba(50, 39, 78, 0.50)",
        "c-primary-dark-700-alpha-600": "rgba(50, 39, 78, 0.40)",
        "c-primary-dark-700-alpha-700": "rgba(50, 39, 78, 0.30)",
        "c-primary-dark-700-alpha-800": "rgba(50, 39, 78, 0.20)",
        "c-primary-dark-700-alpha-900": "rgba(50, 39, 78, 0.10)",
        "c-primary-dark-800": "rgb(45,35,70)",
        "c-primary-dark-800-alpha-100": "rgba(45, 35, 70, 0.90)",
        "c-primary-dark-800-alpha-200": "rgba(45, 35, 70, 0.80)",
        "c-primary-dark-800-alpha-300": "rgba(45, 35, 70, 0.70)",
        "c-primary-dark-800-alpha-400": "rgba(45, 35, 70, 0.60)",
        "c-primary-dark-800-alpha-500": "rgba(45, 35, 70, 0.50)",
        "c-primary-dark-800-alpha-600": "rgba(45, 35, 70, 0.40)",
        "c-primary-dark-800-alpha-700": "rgba(45, 35, 70, 0.30)",
        "c-primary-dark-800-alpha-800": "rgba(45, 35, 70, 0.20)",
        "c-primary-dark-800-alpha-900": "rgba(45, 35, 70, 0.10)",
        "c-primary-dark-900": "rgb(41,32,63)",
        "c-primary-dark-900-alpha-100": "rgba(41, 32, 63, 0.90)",
        "c-primary-dark-900-alpha-200": "rgba(41, 32, 63, 0.80)",
        "c-primary-dark-900-alpha-300": "rgba(41, 32, 63, 0.70)",
        "c-primary-dark-900-alpha-400": "rgba(41, 32, 63, 0.60)",
        "c-primary-dark-900-alpha-500": "rgba(41, 32, 63, 0.50)",
        "c-primary-dark-900-alpha-600": "rgba(41, 32, 63, 0.40)",
        "c-primary-dark-900-alpha-700": "rgba(41, 32, 63, 0.30)",
        "c-primary-dark-900-alpha-800": "rgba(41, 32, 63, 0.20)",
        "c-primary-dark-900-alpha-900": "rgba(41, 32, 63, 0.10)",
        "c-primary-dark-1000": "rgb(37,29,57)",
        "c-primary-dark-1000-alpha-100": "rgba(37, 29, 57, 0.90)",
        "c-primary-dark-1000-alpha-200": "rgba(37, 29, 57, 0.80)",
        "c-primary-dark-1000-alpha-300": "rgba(37, 29, 57, 0.70)",
        "c-primary-dark-1000-alpha-400": "rgba(37, 29, 57, 0.60)",
        "c-primary-dark-1000-alpha-500": "rgba(37, 29, 57, 0.50)",
        "c-primary-dark-1000-alpha-600": "rgba(37, 29, 57, 0.40)",
        "c-primary-dark-1000-alpha-700": "rgba(37, 29, 57, 0.30)",
        "c-primary-dark-1000-alpha-800": "rgba(37, 29, 57, 0.20)",
        "c-primary-dark-1000-alpha-900": "rgba(37, 29, 57, 0.10)",
        "c-primary-light-100": "rgb(133,115,182)",
        "c-primary-light-100-alpha-100": "rgba(133, 115, 182, 0.90)",
        "c-primary-light-100-alpha-200": "rgba(133, 115, 182, 0.80)",
        "c-primary-light-100-alpha-300": "rgba(133, 115, 182, 0.70)",
        "c-primary-light-100-alpha-400": "rgba(133, 115, 182, 0.60)",
        "c-primary-light-100-alpha-500": "rgba(133, 115, 182, 0.50)",
        "c-primary-light-100-alpha-600": "rgba(133, 115, 182, 0.40)",
        "c-primary-light-100-alpha-700": "rgba(133, 115, 182, 0.30)",
        "c-primary-light-100-alpha-800": "rgba(133, 115, 182, 0.20)",
        "c-primary-light-100-alpha-900": "rgba(133, 115, 182, 0.10)",
        "c-primary-light-200": "rgb(157,143,197)",
        "c-primary-light-200-alpha-100": "rgba(157, 143, 197, 0.90)",
        "c-primary-light-200-alpha-200": "rgba(157, 143, 197, 0.80)",
        "c-primary-light-200-alpha-300": "rgba(157, 143, 197, 0.70)",
        "c-primary-light-200-alpha-400": "rgba(157, 143, 197, 0.60)",
        "c-primary-light-200-alpha-500": "rgba(157, 143, 197, 0.50)",
        "c-primary-light-200-alpha-600": "rgba(157, 143, 197, 0.40)",
        "c-primary-light-200-alpha-700": "rgba(157, 143, 197, 0.30)",
        "c-primary-light-200-alpha-800": "rgba(157, 143, 197, 0.20)",
        "c-primary-light-200-alpha-900": "rgba(157, 143, 197, 0.10)",
        "c-primary-light-300": "rgb(177,165,209)",
        "c-primary-light-300-alpha-100": "rgba(177, 165, 209, 0.90)",
        "c-primary-light-300-alpha-200": "rgba(177, 165, 209, 0.80)",
        "c-primary-light-300-alpha-300": "rgba(177, 165, 209, 0.70)",
        "c-primary-light-300-alpha-400": "rgba(177, 165, 209, 0.60)",
        "c-primary-light-300-alpha-500": "rgba(177, 165, 209, 0.50)",
        "c-primary-light-300-alpha-600": "rgba(177, 165, 209, 0.40)",
        "c-primary-light-300-alpha-700": "rgba(177, 165, 209, 0.30)",
        "c-primary-light-300-alpha-800": "rgba(177, 165, 209, 0.20)",
        "c-primary-light-300-alpha-900": "rgba(177, 165, 209, 0.10)",
        "c-primary-light-400": "rgb(193,183,218)",
        "c-primary-light-400-alpha-100": "rgba(193, 183, 218, 0.90)",
        "c-primary-light-400-alpha-200": "rgba(193, 183, 218, 0.80)",
        "c-primary-light-400-alpha-300": "rgba(193, 183, 218, 0.70)",
        "c-primary-light-400-alpha-400": "rgba(193, 183, 218, 0.60)",
        "c-primary-light-400-alpha-500": "rgba(193, 183, 218, 0.50)",
        "c-primary-light-400-alpha-600": "rgba(193, 183, 218, 0.40)",
        "c-primary-light-400-alpha-700": "rgba(193, 183, 218, 0.30)",
        "c-primary-light-400-alpha-800": "rgba(193, 183, 218, 0.20)",
        "c-primary-light-400-alpha-900": "rgba(193, 183, 218, 0.10)",
        "c-primary-light-500": "rgb(205,197,225)",
        "c-primary-light-500-alpha-100": "rgba(205, 197, 225, 0.90)",
        "c-primary-light-500-alpha-200": "rgba(205, 197, 225, 0.80)",
        "c-primary-light-500-alpha-300": "rgba(205, 197, 225, 0.70)",
        "c-primary-light-500-alpha-400": "rgba(205, 197, 225, 0.60)",
        "c-primary-light-500-alpha-500": "rgba(205, 197, 225, 0.50)",
        "c-primary-light-500-alpha-600": "rgba(205, 197, 225, 0.40)",
        "c-primary-light-500-alpha-700": "rgba(205, 197, 225, 0.30)",
        "c-primary-light-500-alpha-800": "rgba(205, 197, 225, 0.20)",
        "c-primary-light-500-alpha-900": "rgba(205, 197, 225, 0.10)",
        "c-primary-light-600": "rgb(215,209,231)",
        "c-primary-light-600-alpha-100": "rgba(215, 209, 231, 0.90)",
        "c-primary-light-600-alpha-200": "rgba(215, 209, 231, 0.80)",
        "c-primary-light-600-alpha-300": "rgba(215, 209, 231, 0.70)",
        "c-primary-light-600-alpha-400": "rgba(215, 209, 231, 0.60)",
        "c-primary-light-600-alpha-500": "rgba(215, 209, 231, 0.50)",
        "c-primary-light-600-alpha-600": "rgba(215, 209, 231, 0.40)",
        "c-primary-light-600-alpha-700": "rgba(215, 209, 231, 0.30)",
        "c-primary-light-600-alpha-800": "rgba(215, 209, 231, 0.20)",
        "c-primary-light-600-alpha-900": "rgba(215, 209, 231, 0.10)",
        "c-primary-light-700": "rgb(223,218,236)",
        "c-primary-light-700-alpha-100": "rgba(223, 218, 236, 0.90)",
        "c-primary-light-700-alpha-200": "rgba(223, 218, 236, 0.80)",
        "c-primary-light-700-alpha-300": "rgba(223, 218, 236, 0.70)",
        "c-primary-light-700-alpha-400": "rgba(223, 218, 236, 0.60)",
        "c-primary-light-700-alpha-500": "rgba(223, 218, 236, 0.50)",
        "c-primary-light-700-alpha-600": "rgba(223, 218, 236, 0.40)",
        "c-primary-light-700-alpha-700": "rgba(223, 218, 236, 0.30)",
        "c-primary-light-700-alpha-800": "rgba(223, 218, 236, 0.20)",
        "c-primary-light-700-alpha-900": "rgba(223, 218, 236, 0.10)",
        "c-primary-light-800": "rgb(229,225,240)",
        "c-primary-light-800-alpha-100": "rgba(229, 225, 240, 0.90)",
        "c-primary-light-800-alpha-200": "rgba(229, 225, 240, 0.80)",
        "c-primary-light-800-alpha-300": "rgba(229, 225, 240, 0.70)",
        "c-primary-light-800-alpha-400": "rgba(229, 225, 240, 0.60)",
        "c-primary-light-800-alpha-500": "rgba(229, 225, 240, 0.50)",
        "c-primary-light-800-alpha-600": "rgba(229, 225, 240, 0.40)",
        "c-primary-light-800-alpha-700": "rgba(229, 225, 240, 0.30)",
        "c-primary-light-800-alpha-800": "rgba(229, 225, 240, 0.20)",
        "c-primary-light-800-alpha-900": "rgba(229, 225, 240, 0.10)",
        "c-primary-light-900": "rgb(234,231,243)",
        "c-primary-light-900-alpha-100": "rgba(234, 231, 243, 0.90)",
        "c-primary-light-900-alpha-200": "rgba(234, 231, 243, 0.80)",
        "c-primary-light-900-alpha-300": "rgba(234, 231, 243, 0.70)",
        "c-primary-light-900-alpha-400": "rgba(234, 231, 243, 0.60)",
        "c-primary-light-900-alpha-500": "rgba(234, 231, 243, 0.50)",
        "c-primary-light-900-alpha-600": "rgba(234, 231, 243, 0.40)",
        "c-primary-light-900-alpha-700": "rgba(234, 231, 243, 0.30)",
        "c-primary-light-900-alpha-800": "rgba(234, 231, 243, 0.20)",
        "c-primary-light-900-alpha-900": "rgba(234, 231, 243, 0.10)",
        ...
        "c-600": "rgb(119,118,121)",
        "c-550": "rgb(130,130,132)",
        "c-500": "rgb(142,141,143)",
        "c-450": "rgb(153,152,154)",
        "c-400": "rgb(164,164,165)",
        "c-350": "rgb(176,175,177)",
        "c-300": "rgb(187,187,188)",
        "c-250": "rgb(198,198,199)",
        "c-200": "rgb(210,209,210)",
  ...
  },
  {
    ...
    "config": {
      "themeColors": {
        ...
        "c-primary-dark-100": "rgb(255,255,255)",
        "c-primary-dark-100-alpha-100": "rgba(255, 255, 255, 0.90)",
        "c-primary-alpha-100": "rgba(255, 255, 255, 0.90)",
        "c-primary-dark-100-alpha-200": "rgba(255, 255, 255, 0.80)",
        "c-primary-alpha-200": "rgba(255, 255, 255, 0.80)",
        "c-primary-dark-100-alpha-300": "rgba(255, 255, 255, 0.70)",
        "c-primary-alpha-300": "rgba(255, 255, 255, 0.70)",
        "c-primary-dark-100-alpha-400": "rgba(255, 255, 255, 0.60)",
        "c-primary-alpha-400": "rgba(255, 255, 255, 0.60)",
        "c-primary-dark-100-alpha-500": "rgba(255, 255, 255, 0.50)",
        "c-primary-alpha-500": "rgba(255, 255, 255, 0.50)",
        "c-primary-dark-100-alpha-600": "rgba(255, 255, 255, 0.40)",
        "c-primary-alpha-600": "rgba(255, 255, 255, 0.40)",
        "c-primary-dark-100-alpha-700": "rgba(255, 255, 255, 0.30)",
        "c-primary-alpha-700": "rgba(255, 255, 255, 0.30)",
        "c-primary-dark-100-alpha-800": "rgba(255, 255, 255, 0.20)",
        "c-primary-alpha-800": "rgba(255, 255, 255, 0.20)",
        "c-primary-dark-100-alpha-900": "rgba(255, 255, 255, 0.10)",
        "c-primary-alpha-900": "rgba(255, 255, 255, 0.10)",
        "c-primary-dark-200": "rgb(255,255,255)",
        "c-primary-dark-200-alpha-100": "rgba(255, 255, 255, 0.90)",
        "c-primary-dark-200-alpha-200": "rgba(255, 255, 255, 0.80)",
        "c-primary-dark-200-alpha-300": "rgba(255, 255, 255, 0.70)",
        "c-primary-dark-200-alpha-400": "rgba(255, 255, 255, 0.60)",
        "c-primary-dark-200-alpha-500": "rgba(255, 255, 255, 0.50)",
        "c-primary-dark-200-alpha-600": "rgba(255, 255, 255, 0.40)",
        "c-primary-dark-200-alpha-700": "rgba(255, 255, 255, 0.30)",
        "c-primary-dark-200-alpha-800": "rgba(255, 255, 255, 0.20)",
        "c-primary-dark-200-alpha-900": "rgba(255, 255, 255, 0.10)",
        "c-primary-dark-300": "rgb(255,255,255)",
        "c-primary-dark-300-alpha-100": "rgba(255, 255, 255, 0.90)",
        "c-primary-dark-300-alpha-200": "rgba(255, 255, 255, 0.80)",
        "c-primary-dark-300-alpha-300": "rgba(255, 255, 255, 0.70)",
        "c-primary-dark-300-alpha-400": "rgba(255, 255, 255, 0.60)",
        "c-primary-dark-300-alpha-500": "rgba(255, 255, 255, 0.50)",
        "c-primary-dark-300-alpha-600": "rgba(255, 255, 255, 0.40)",
        "c-primary-dark-300-alpha-700": "rgba(255, 255, 255, 0.30)",
        "c-primary-dark-300-alpha-800": "rgba(255, 255, 255, 0.20)",
        "c-primary-dark-300-alpha-900": "rgba(255, 255, 255, 0.10)",
        "c-primary-dark-400": "rgb(255,255,255)",
        "c-primary-dark-400-alpha-100": "rgba(255, 255, 255, 0.90)",
        "c-primary-dark-400-alpha-200": "rgba(255, 255, 255, 0.80)",
        "c-primary-dark-400-alpha-300": "rgba(255, 255, 255, 0.70)",
        "c-primary-dark-400-alpha-400": "rgba(255, 255, 255, 0.60)",
        "c-primary-dark-400-alpha-500": "rgba(255, 255, 255, 0.50)",
        "c-primary-dark-400-alpha-600": "rgba(255, 255, 255, 0.40)",
        "c-primary-dark-400-alpha-700": "rgba(255, 255, 255, 0.30)",
        "c-primary-dark-400-alpha-800": "rgba(255, 255, 255, 0.20)",
        "c-primary-dark-400-alpha-900": "rgba(255, 255, 255, 0.10)",
        "c-primary-dark-500": "rgb(255,255,255)",
        "c-primary-dark-500-alpha-100": "rgba(255, 255, 255, 0.90)",
        "c-primary-dark-500-alpha-200": "rgba(255, 255, 255, 0.80)",
        "c-primary-dark-500-alpha-300": "rgba(255, 255, 255, 0.70)",
        "c-primary-dark-500-alpha-400": "rgba(255, 255, 255, 0.60)",
        "c-primary-dark-500-alpha-500": "rgba(255, 255, 255, 0.50)",
        "c-primary-dark-500-alpha-600": "rgba(255, 255, 255, 0.40)",
        "c-primary-dark-500-alpha-700": "rgba(255, 255, 255, 0.30)",
        "c-primary-dark-500-alpha-800": "rgba(255, 255, 255, 0.20)",
        "c-primary-dark-500-alpha-900": "rgba(255, 255, 255, 0.10)",
        "c-primary-dark-600": "rgb(255,255,255)",
        "c-primary-dark-600-alpha-100": "rgba(255, 255, 255, 0.90)",
        "c-primary-dark-600-alpha-200": "rgba(255, 255, 255, 0.80)",
        "c-primary-dark-600-alpha-300": "rgba(255, 255, 255, 0.70)",
        "c-primary-dark-600-alpha-400": "rgba(255, 255, 255, 0.60)",
        "c-primary-dark-600-alpha-500": "rgba(255, 255, 255, 0.50)",
        "c-primary-dark-600-alpha-600": "rgba(255, 255, 255, 0.40)",
        "c-primary-dark-600-alpha-700": "rgba(255, 255, 255, 0.30)",
        "c-primary-dark-600-alpha-800": "rgba(255, 255, 255, 0.20)",
        "c-primary-dark-600-alpha-900": "rgba(255, 255, 255, 0.10)",
        "c-primary-dark-700": "rgb(255,255,255)",
        "c-primary-dark-700-alpha-100": "rgba(255, 255, 255, 0.90)",
        "c-primary-dark-700-alpha-200": "rgba(255, 255, 255, 0.80)",
        "c-primary-dark-700-alpha-300": "rgba(255, 255, 255, 0.70)",
        "c-primary-dark-700-alpha-400": "rgba(255, 255, 255, 0.60)",
        "c-primary-dark-700-alpha-500": "rgba(255, 255, 255, 0.50)",
        "c-primary-dark-700-alpha-600": "rgba(255, 255, 255, 0.40)",
        "c-primary-dark-700-alpha-700": "rgba(255, 255, 255, 0.30)",
        "c-primary-dark-700-alpha-800": "rgba(255, 255, 255, 0.20)",
        "c-primary-dark-700-alpha-900": "rgba(255, 255, 255, 0.10)",
        "c-primary-dark-800": "rgb(255,255,255)",
        "c-primary-dark-800-alpha-100": "rgba(255, 255, 255, 0.90)",
        "c-primary-dark-800-alpha-200": "rgba(255, 255, 255, 0.80)",
        "c-primary-dark-800-alpha-300": "rgba(255, 255, 255, 0.70)",
        "c-primary-dark-800-alpha-400": "rgba(255, 255, 255, 0.60)",
        "c-primary-dark-800-alpha-500": "rgba(255, 255, 255, 0.50)",
        "c-primary-dark-800-alpha-600": "rgba(255, 255, 255, 0.40)",
        "c-primary-dark-800-alpha-700": "rgba(255, 255, 255, 0.30)",
        "c-primary-dark-800-alpha-800": "rgba(255, 255, 255, 0.20)",
        "c-primary-dark-800-alpha-900": "rgba(255, 255, 255, 0.10)",
        "c-primary-dark-900": "rgb(255,255,255)",
        "c-primary-dark-900-alpha-100": "rgba(255, 255, 255, 0.90)",
        "c-primary-dark-900-alpha-200": "rgba(255, 255, 255, 0.80)",
        "c-primary-dark-900-alpha-300": "rgba(255, 255, 255, 0.70)",
        "c-primary-dark-900-alpha-400": "rgba(255, 255, 255, 0.60)",
        "c-primary-dark-900-alpha-500": "rgba(255, 255, 255, 0.50)",
        "c-primary-dark-900-alpha-600": "rgba(255, 255, 255, 0.40)",
        "c-primary-dark-900-alpha-700": "rgba(255, 255, 255, 0.30)",
        "c-primary-dark-900-alpha-800": "rgba(255, 255, 255, 0.20)",
        "c-primary-dark-900-alpha-900": "rgba(255, 255, 255, 0.10)",
        "c-primary-dark-1000": "rgb(255,255,255)",
        "c-primary-dark-1000-alpha-100": "rgba(255, 255, 255, 0.90)",
        "c-primary-dark-1000-alpha-200": "rgba(255, 255, 255, 0.80)",
        "c-primary-dark-1000-alpha-300": "rgba(255, 255, 255, 0.70)",
        "c-primary-dark-1000-alpha-400": "rgba(255, 255, 255, 0.60)",
        "c-primary-dark-1000-alpha-500": "rgba(255, 255, 255, 0.50)",
        "c-primary-dark-1000-alpha-600": "rgba(255, 255, 255, 0.40)",
        "c-primary-dark-1000-alpha-700": "rgba(255, 255, 255, 0.30)",
        "c-primary-dark-1000-alpha-800": "rgba(255, 255, 255, 0.20)",
        "c-primary-dark-1000-alpha-900": "rgba(255, 255, 255, 0.10)",
        "c-primary-light-100": "rgb(230,230,230)",
        "c-primary-light-100-alpha-100": "rgba(230, 230, 230, 0.90)",
        "c-primary-light-100-alpha-200": "rgba(230, 230, 230, 0.80)",
        "c-primary-light-100-alpha-300": "rgba(230, 230, 230, 0.70)",
        "c-primary-light-100-alpha-400": "rgba(230, 230, 230, 0.60)",
        "c-primary-light-100-alpha-500": "rgba(230, 230, 230, 0.50)",
        "c-primary-light-100-alpha-600": "rgba(230, 230, 230, 0.40)",
        "c-primary-light-100-alpha-700": "rgba(230, 230, 230, 0.30)",
        "c-primary-light-100-alpha-800": "rgba(230, 230, 230, 0.20)",
        "c-primary-light-100-alpha-900": "rgba(230, 230, 230, 0.10)",
        "c-primary-light-200": "rgb(207,207,207)",
        "c-primary-light-200-alpha-100": "rgba(207, 207, 207, 0.90)",
        "c-primary-light-200-alpha-200": "rgba(207, 207, 207, 0.80)",
        "c-primary-light-200-alpha-300": "rgba(207, 207, 207, 0.70)",
        "c-primary-light-200-alpha-400": "rgba(207, 207, 207, 0.60)",
        "c-primary-light-200-alpha-500": "rgba(207, 207, 207, 0.50)",
        "c-primary-light-200-alpha-600": "rgba(207, 207, 207, 0.40)",
        "c-primary-light-200-alpha-700": "rgba(207, 207, 207, 0.30)",
        "c-primary-light-200-alpha-800": "rgba(207, 207, 207, 0.20)",
        "c-primary-light-200-alpha-900": "rgba(207, 207, 207, 0.10)",
        "c-primary-light-300": "rgb(186,186,186)",
        "c-primary-light-300-alpha-100": "rgba(186, 186, 186, 0.90)",
        "c-primary-light-300-alpha-200": "rgba(186, 186, 186, 0.80)",
        "c-primary-light-300-alpha-300": "rgba(186, 186, 186, 0.70)",
        "c-primary-light-300-alpha-400": "rgba(186, 186, 186, 0.60)",
        "c-primary-light-300-alpha-500": "rgba(186, 186, 186, 0.50)",
        "c-primary-light-300-alpha-600": "rgba(186, 186, 186, 0.40)",
        "c-primary-light-300-alpha-700": "rgba(186, 186, 186, 0.30)",
        "c-primary-light-300-alpha-800": "rgba(186, 186, 186, 0.20)",
        "c-primary-light-300-alpha-900": "rgba(186, 186, 186, 0.10)",
        "c-primary-light-400": "rgb(167,167,167)",
        "c-primary-light-400-alpha-100": "rgba(167, 167, 167, 0.90)",
        "c-primary-light-400-alpha-200": "rgba(167, 167, 167, 0.80)",
        "c-primary-light-400-alpha-300": "rgba(167, 167, 167, 0.70)",
        "c-primary-light-400-alpha-400": "rgba(167, 167, 167, 0.60)",
        "c-primary-light-400-alpha-500": "rgba(167, 167, 167, 0.50)",
        "c-primary-light-400-alpha-600": "rgba(167, 167, 167, 0.40)",
        "c-primary-light-400-alpha-700": "rgba(167, 167, 167, 0.30)",
        "c-primary-light-400-alpha-800": "rgba(167, 167, 167, 0.20)",
        "c-primary-light-400-alpha-900": "rgba(167, 167, 167, 0.10)",
        "c-primary-light-500": "rgb(150,150,150)",
        "c-primary-light-500-alpha-100": "rgba(150, 150, 150, 0.90)",
        "c-primary-light-500-alpha-200": "rgba(150, 150, 150, 0.80)",
        "c-primary-light-500-alpha-300": "rgba(150, 150, 150, 0.70)",
        "c-primary-light-500-alpha-400": "rgba(150, 150, 150, 0.60)",
        "c-primary-light-500-alpha-500": "rgba(150, 150, 150, 0.50)",
        "c-primary-light-500-alpha-600": "rgba(150, 150, 150, 0.40)",
        "c-primary-light-500-alpha-700": "rgba(150, 150, 150, 0.30)",
        "c-primary-light-500-alpha-800": "rgba(150, 150, 150, 0.20)",
        "c-primary-light-500-alpha-900": "rgba(150, 150, 150, 0.10)",
        "c-primary-light-600": "rgb(135,135,135)",
        "c-primary-light-600-alpha-100": "rgba(135, 135, 135, 0.90)",
        "c-primary-light-600-alpha-200": "rgba(135, 135, 135, 0.80)",
        "c-primary-light-600-alpha-300": "rgba(135, 135, 135, 0.70)",
        "c-primary-light-600-alpha-400": "rgba(135, 135, 135, 0.60)",
        "c-primary-light-600-alpha-500": "rgba(135, 135, 135, 0.50)",
        "c-primary-light-600-alpha-600": "rgba(135, 135, 135, 0.40)",
        "c-primary-light-600-alpha-700": "rgba(135, 135, 135, 0.30)",
        "c-primary-light-600-alpha-800": "rgba(135, 135, 135, 0.20)",
        "c-primary-light-600-alpha-900": "rgba(135, 135, 135, 0.10)",
        "c-primary-light-700": "rgb(122,122,122)",
        "c-primary-light-700-alpha-100": "rgba(122, 122, 122, 0.90)",
        "c-primary-light-700-alpha-200": "rgba(122, 122, 122, 0.80)",
        "c-primary-light-700-alpha-300": "rgba(122, 122, 122, 0.70)",
        "c-primary-light-700-alpha-400": "rgba(122, 122, 122, 0.60)",
        "c-primary-light-700-alpha-500": "rgba(122, 122, 122, 0.50)",
        "c-primary-light-700-alpha-600": "rgba(122, 122, 122, 0.40)",
        "c-primary-light-700-alpha-700": "rgba(122, 122, 122, 0.30)",
        "c-primary-light-700-alpha-800": "rgba(122, 122, 122, 0.20)",
        "c-primary-light-700-alpha-900": "rgba(122, 122, 122, 0.10)",
        "c-primary-light-800": "rgb(110,110,110)",
        "c-primary-light-800-alpha-100": "rgba(110, 110, 110, 0.90)",
        "c-primary-light-800-alpha-200": "rgba(110, 110, 110, 0.80)",
        "c-primary-light-800-alpha-300": "rgba(110, 110, 110, 0.70)",
        "c-primary-light-800-alpha-400": "rgba(110, 110, 110, 0.60)",
        "c-primary-light-800-alpha-500": "rgba(110, 110, 110, 0.50)",
        "c-primary-light-800-alpha-600": "rgba(110, 110, 110, 0.40)",
        "c-primary-light-800-alpha-700": "rgba(110, 110, 110, 0.30)",
        "c-primary-light-800-alpha-800": "rgba(110, 110, 110, 0.20)",
        "c-primary-light-800-alpha-900": "rgba(110, 110, 110, 0.10)",
        "c-primary-light-900": "rgb(99,99,99)",
        "c-primary-light-900-alpha-100": "rgba(99, 99, 99, 0.90)",
        "c-primary-light-900-alpha-200": "rgba(99, 99, 99, 0.80)",
        "c-primary-light-900-alpha-300": "rgba(99, 99, 99, 0.70)",
        "c-primary-light-900-alpha-400": "rgba(99, 99, 99, 0.60)",
        "c-primary-light-900-alpha-500": "rgba(99, 99, 99, 0.50)",
        "c-primary-light-900-alpha-600": "rgba(99, 99, 99, 0.40)",
        "c-primary-light-900-alpha-700": "rgba(99, 99, 99, 0.30)",
        "c-primary-light-900-alpha-800": "rgba(99, 99, 99, 0.20)",
        "c-primary-light-900-alpha-900": "rgba(99, 99, 99, 0.10)",
        "c-primary-light-1000": "rgb(64,64,64)",
        "c-primary-light-1000-alpha-100": "rgba(64, 64, 64, 0.90)",
        "c-primary-light-1000-alpha-200": "rgba(64, 64, 64, 0.80)",
        "c-primary-light-1000-alpha-300": "rgba(64, 64, 64, 0.70)",
        "c-primary-light-1000-alpha-400": "rgba(64, 64, 64, 0.60)",
        "c-primary-light-1000-alpha-500": "rgba(64, 64, 64, 0.50)",
        "c-primary-light-1000-alpha-600": "rgba(64, 64, 64, 0.40)",
        "c-primary-light-1000-alpha-700": "rgba(64, 64, 64, 0.30)",
        "c-primary-light-1000-alpha-800": "rgba(64, 64, 64, 0.20)",
        "c-primary-light-1000-alpha-900": "rgba(64, 64, 64, 0.10)",
        "c-theme": "rgb(99,99,99)",
